...
\begin{tabular}{rl}
    ...
    \textsc{Email:}     & \href{mailto:julien.maupetit@comsource.fr}{julien.maupetit@comsource.fr}\\
...
\begin{longtable}{r|p{11cm}}
  ...
  \emph{Current} & Web Developer \& Co-Manager at \textsc{\href{http://www.agence-comsource.com}{ComSource}} \\
...
Web development:& \{ \textit{front end} \} \textsc{HTML5}, \textsc{CSS3}, \textsc{SASS} (\textsc{Compass}), \textsc{Javascript/AJAX} (\textsc{jQuery})\\
&\{ \textit{back end} \} \textsc{PHP}, \textsc{Python} (Django, CGI)\\
